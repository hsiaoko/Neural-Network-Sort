...
main:./obj/main.o ./obj/map.o ./obj/util.o ./obj/cuda.o ./obj/quick.o
	nvcc -o main ./obj/main.o ./obj/map.o ./obj/util.o ./obj/cuda.o ./obj/quick.o -I ./include --std=c++11
...
./obj/quick.o:./src/quick.cc
	g++ -c ./src/quick.cc -o ./obj/quick.o -I ./include --std=c++11
